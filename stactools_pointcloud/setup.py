...
name = 'stactools_pointcloud'
description = ("Subpackage for working with point cloud data in stactools, "
               "a command line tool and Python library for working with STAC.")

__version__ = load_source(
    'stactools.pointcloud.version',
    os.path.join(os.path.dirname(__file__),
                 'stactools/pointcloud/version.py')).__version__
...
setup(name=name,
      ...
      keywords=['stactools', 'psytac', 'pointcloud', 'catalog', 'STAC'])
