...
name = 'stactools_goes'
description = ("Subpackage for working with GOES data in stactools, "
               "a command line tool and Python library for working with STAC.")

__version__ = load_source(
    'stactools.goes.version',
    os.path.join(os.path.dirname(__file__),
                 'stactools/goes/version.py')).__version__
...
setup(name=name,
      ...
      keywords=[
          'stactools', 'psytac', 'raster', 'catalog', 'STAC', 'GOES', 'weather'
      ])
