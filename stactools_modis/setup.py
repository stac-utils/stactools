...
name = 'stactools_modis'
description = ("Subpackage for working with modis data in stactools, "
               "a command line tool and Python library for working with STAC.")

__version__ = load_source(
    'stactools.modis.version',
    os.path.join(os.path.dirname(__file__),
                 'stactools/modis/version.py')).__version__
...
setup(name=name,
      ...
      keywords=[
          'stactools', 'psytac', 'modis', 'imagery', 'nasa', 'catalog', 'STAC',
          'usgs'
      ])
